...
INAUGURATION_ITEMS = [
    ...
    ("guests-seated",
     "Mr. Dashrath Bhagat, Deputy Mayor of Navi Mumbai, seated on the left with two other guests in front of the event banner",
     "Mr. Dashrath Bhagat, Deputy Mayor of Navi Mumbai"),
    ("felicitation",
