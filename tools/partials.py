...
INAUGURATION_ITEMS = [
    ("ribbon-cutting",
     "Hon. Shri Ganesh Naik cutting the ribbon at the clinic entrance, with Dr. Adarsh Patil and other guests standing on either side",
     "Hon. Shri Ganesh Naik cutting the ribbon"),
    ("chief-guest-address",
     "Hon. Shri Ganesh Naik speaking into a microphone in front of the clinic's inauguration banner, with invited guests seated behind",
     "Hon. Shri Ganesh Naik addressing the gathering"),
    ("address-wide",
     "Wider view of the stage during Hon. Shri Ganesh Naik's address, with invited guests seated on either side and attendees watching",
     "The ceremony under way"),
    ("guests-on-dais",
     "Hon. Shri Ganesh Naik seated at the centre of the stage with Dr. Adarsh Patil and other invited guests, in front of the inauguration banner",
     "Invited guests on the dais"),
    ("guests-seated",
     "Hon. Shri Ganesh Naik, Minister, Government of Maharashtra, seated at the centre between two invited guests in front of the event banner",
    ...
    ("consulting-room-guests",
     "Dr. Adarsh Patil standing with Hon. Shri Ganesh Naik and other guests in the consulting room, with framed certificates on the wall behind",
     "Hon. Shri Ganesh Naik in the consulting room"),
    ("consulting-room-visit",
     "Dr. Adarsh Patil standing with Hon. Shri Ganesh Naik and other visitors beside the consultation desk",
